...
export const productoValidationSchema = yup.object( {
    ...
    precion: yup.number().required('el precio es requerido').positive('El precio debe ser positivo'),
    categoria_id: yup.number().required('por favor seleccione una categoria'),
})
